...
public class ExamDaoImplTest {
    ...
    public void getSolutionById() {
        final Map<String, Object> questionById = examDao.getSolutionById("1");

        softly.assertThat(questionById).isNotEmpty();
        softly.assertThat(questionById.keySet().toString()).isEqualTo("[1]");
        softly.assertThat(questionById.values().toString()).contains("A.");
        softly.assertThat(questionById.values().toString()).contains("It would be better to pass Object");
        softly.assertAll();
    }
    ...
    @Test
    public void searchSolutionById_functionalId() {
        final Map<String, Object> questionByFunctionalIdId = examDao.searchSolutionByQuestionId("ch3-q20");

        softly.assertThat(questionByFunctionalIdId).isNotEmpty();
        softly.assertThat(questionByFunctionalIdId.keySet().size()).isEqualTo(1);
        softly.assertThat(questionByFunctionalIdId.values().toString()).contains(("E."));
        softly.assertThat(questionByFunctionalIdId.values().toString()).contains(("This question looks like it is about generics"));
        softly.assertThat(questionByFunctionalIdId.values().toString()).contains("chapitre=3");
        softly.assertAll();
    }
    ...
    @Test
    public void searchSolutionsByChapterId_Chap1() {

        final Map<String, Object> stringObjectMap = examDao.searchSolutionsByChapterId("1");
    ...
    @Test
    public void searchSolutionsByChapterId_Chap2() {

        final Map<String, Object> stringObjectMap = examDao.searchSolutionsByChapterId("2");
    ...
    @Test
    public void searchSolutionsByChapterId_Chap3() {

        final Map<String, Object> stringObjectMap = examDao.searchSolutionsByChapterId("3");
    ...
    @Test
    public void searchSolutionsByChapterId_Chap4() {

        final Map<String, Object> stringObjectMap = examDao.searchSolutionsByChapterId("4");
    ...
    @Test
    public void searchSolutionsByChapterId_Chap5() {

        final Map<String, Object> stringObjectMap = examDao.searchSolutionsByChapterId("5");
    ...
    @Test
    public void searchSolutionsByChapterId_Chap6() {

        final Map<String, Object> stringObjectMap = examDao.searchSolutionsByChapterId("6");
    ...
    @Test
    public void searchSolutionsByChapterId_Chap7() {

        final Map<String, Object> stringObjectMap = examDao.searchSolutionsByChapterId("7");
    ...
    @Test
    public void searchSolutionsByChapterId_Chap8() {

        final Map<String, Object> stringObjectMap = examDao.searchSolutionsByChapterId("8");
    ...
    @Test
    public void searchSolutionsByChapterId_Chap9() {

        final Map<String, Object> stringObjectMap = examDao.searchSolutionsByChapterId("9");
    ...
    @Test
    public void searchSolutionsByChapterId_Chap10() {

        final Map<String, Object> stringObjectMap = examDao.searchSolutionsByChapterId("10");
    ...
    @Test
    public void searchAllChaptersSolutions() {
           thrown.expect(QuestionNotFoundException.class);
           thrown.expectMessage("No Question Found For search Criteria :N");

           examDao.searchAllSolutionsByExamType("N");
